ManagedShovel is an external replacement for RabbitMQ built-in shovel plugin.

Downloadable packages can be found on the CI server, kindly hosted by CodeBetter.
...
For any additional information donìt hesitate to contact me.